(function () {
  var app = angular.module("NumberStroopExperimentApp", ["Lingoturk"]);
  ...
  app.controller("RenderController", [
    ...
    function ($http, $timeout, $scope) {
      ...
      self.practiceQuestions = [
        { item: "2", totalDigits: "1", trialType: "incongruent" },
        { item: "3333", totalDigits: "4", trialType: "incongruent" },
        { item: "11", totalDigits: "2", trialType: "incongruent" },
        { item: "22", totalDigits: "2", trialType: "congruent" },
        { item: "333", totalDigits: "3", trialType: "congruent" },
        { item: "1", totalDigits: "1", trialType: "congruent" },
        { item: "4", totalDigits: "1", trialType: "incongruent" },
        { item: "4444", totalDigits: "4", trialType: "congruent" },
        { item: "1", totalDigits: "1", trialType: "congruent" },
        { item: "222", totalDigits: "3", trialType: "incongruent" },
        { item: "44", totalDigits: "2", trialType: "incongruent" },
        { item: "444", totalDigits: "3", trialType: "incongruent" },
        { item: "2", totalDigits: "1", trialType: "incongruent" },
        { item: "22", totalDigits: "2", trialType: "congruent" },
        { item: "333", totalDigits: "3", trialType: "congruent" },
        { item: "3", totalDigits: "1", trialType: "incongruent" },
        { item: "1", totalDigits: "1", trialType: "congruent" },
        { item: "11", totalDigits: "2", trialType: "incongruent" },
        { item: "22", totalDigits: "2", trialType: "congruent" },
        { item: "22", totalDigits: "2", trialType: "congruent" },
            ...
            $timeout(function () {
              ...
              if (self.state === "questionSlide") {
                ...
                if (!$scope.response) {
                  ...
                  $scope.message =
                    $scope.response ==
                    self.practiceQuestions[self.practiceQuestionIndex]
                      .totalDigits
                      ? "correct"
                      : "incorrect";
                }
      ...
      this.submitResults = function (successCallback, errorCallback) {
        var results = {
          experimentType: "NumberStroopExperiment",
