(function () {
  var app = angular.module("SqauredStroopExperimentApp", ["Lingoturk"]);
  ...
  app.controller("RenderController", [
    ...
    function ($http, $timeout, $scope, $interval) {
      ...
      self.practiceTrialQuestions = Array(10).fill(stimuli_stroop).flat();
      ...
      this.submitResults = function (successCallback, errorCallback) {
        var results = {
          experimentType: "SqauredStroopExperiment",
      ...
      this.savePracticeAnswer = function (ans) {
        ...
        question.answer = {
          response: ans,
          isCorrect: ans === question.response,
        };
        $scope.correct = ans === question.response;
        if ($scope.correct) {
