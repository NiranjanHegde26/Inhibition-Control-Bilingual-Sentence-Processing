(function () {
  var app = angular.module("NonlinguisticSimonExperimentApp", ["Lingoturk"]);
  ...
  app.controller("RenderController", [
    ...
    function ($http, $timeout, $scope, $interval) {
      ...
      $scope.initializeTrial = function () {
        ...
        }, 800); // My thoughts, increasing this to at least 1 seconds as opposed to 500ms from Macizo et al.
      };
      self.start = false;
      ...
      // // if (self.state === "instructionSlide" && event.keyCode === 32) {
      // //   event.preventDefault();
      // //   self.next();
      // // }
      ...
      this.submitResults = function (successCallback, errorCallback) {
        var results = {
          experimentType: "NonlinguisticSimonExperiment",
