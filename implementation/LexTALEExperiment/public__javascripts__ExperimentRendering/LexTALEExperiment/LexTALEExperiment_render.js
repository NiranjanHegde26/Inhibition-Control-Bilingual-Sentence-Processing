(function () {
  var app = angular.module("LexTALEExperimentApp", ["Lingoturk"]);
  ...
  app.controller("RenderController", [
    ...
    function ($http, $timeout, $scope) {
      ...
      this.validate = function () {
        if (
          self.postExperimentFeedback.priorExperience.trim() == "" ||
          self.postExperimentFeedback.strategyUsed.trim() === "" ||
          self.postExperimentFeedback.experimentMotive.trim() === ""
        ) {
          return true;
        }
        return false;
      ...
      this.toggle = function () {
        self.showMotivation = !self.showMotivation;
      };
      ...
      this.submitResults = function (successCallback, errorCallback) {
        var results = {
          experimentType: "LexTALEExperiment",
          results: self.questions,
          expId: self.expId,
          origin: self.origin,
          statistics: self.postExperimentFeedback,
      ...
      this.nextQuestion = function (ans) {
        self.questions[self.questionIndex].answer = {
          selected: ans,
          isCorrect:
            ans == parseInt(self.questions[self.questionIndex].wordStatus),
        };
